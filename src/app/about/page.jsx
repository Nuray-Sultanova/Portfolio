...
import { User, Code2, GraduationCap, Coffee, Globe2, Zap, Heart, Brackets } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <div className="md:col-span-7 bg-[#0C0C0C] border border-white/5 rounded-[2.5rem] p-8 md:p-12 flex flex-col justify-center space-y-6">
            ...
            <h3 className="text-3xl font-bold leading-tight">
              Kod yazmaq mənim üçün sadəcə iş deyil, <span className="text-white">rəqəmsal incəsənətdir</span>.
            </h3>
            <p className="text-slate-400 leading-relaxed font-light text-lg">
              Mən Nuray, Bakıda fəaliyyət göstərən Frontend Developerəm. Son bir neçə ildə özümü Next.js və müasir UI arxitekturalarına həsr etmişəm. Məqsədim yalnız işləyən deyil, həm də istifadəçini vizual olaraq valeh edən interfeyslər yaratmaqdır.
            </p>
          ...
          <div className="md:col-span-5 bg-[#0C0C0C] border border-white/5 rounded-[2.5rem] p-10 flex flex-col justify-between group hover:border-rose-500/20 transition-all">
            ...
            <div>
              <h4 className="text-xl font-bold mb-2 uppercase tracking-tighter">Akademik Keçmiş</h4>
              <p className="text-slate-500 text-sm font-light uppercase tracking-widest leading-loose">
                Kompyuter Mühəndisliyi <br /> 
                <span className="text-white/50 text-[10px] tracking-normal lowercase italic underline underline-offset-4 decoration-rose-500">Daimi öyrənmə prosesində...</span>
              </p>
            </div>
          </div>
          ...
          <div className="md:col-span-4 bg-[#0C0C0C] border border-white/5 rounded-[2.5rem] p-10 flex flex-col items-center justify-center text-center space-y-4 group">
            <div className="relative">
                ...
                <Coffee size={40} className="relative text-rose-500 group-hover:rotate-12 transition-transform" />
            </div>
            <h4 className="text-lg font-bold uppercase tracking-widest">Coffee & Code</h4>
            <p className="text-sm text-slate-500 font-light">
              Mükəmməl bir espresso və sakit bir mühit mənim ən böyük motivasiyamdır.
            </p>
          </div>
          ...
          <div className="md:col-span-5 bg-[#0C0C0C] border border-white/5 rounded-[2.5rem] p-10 flex flex-col justify-between relative overflow-hidden">
             ...
             <div className="space-y-4">
                ...
                <ul className="space-y-3">
                  {['Performans İlkdir', 'Piksel Mükəmməlliyi', 'Təmiz Kod Strukturu'].map((item) => (
          ...
          <div className="md:col-span-3 bg-rose-500 rounded-[2.5rem] p-8 flex flex-col justify-center items-center text-black group relative overflow-hidden">
            <Code2 size={60} className="opacity-10 absolute -left-4 -bottom-4 group-hover:scale-150 transition-transform duration-700" />
            <span className="text-[10px] font-black uppercase tracking-[0.3em] mb-2 opacity-70">Focusing on</span>
            <span className="text-4xl font-black italic tracking-tighter uppercase">NEXTJS</span>
          </div>
